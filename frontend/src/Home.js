...
function Home() {
  ...
  const handleMouseMove = (e) => {
    if (isResizingLeft.current) {
      ...
      let newLeftWidth = ((leftWidth * totalWidth) / 100 + deltaX) / totalWidth * 100;
      let newCenterWidth = ((centerWidth * totalWidth) / 100 - deltaX) / totalWidth * 100;
      ...
      const deltaX = -e.movementX;
      const totalWidth = window.innerWidth;
      let newRightWidth = ((rightWidth * totalWidth) / 100 + deltaX) / totalWidth * 100;
      let newCenterWidth = ((centerWidth * totalWidth) / 100 - deltaX) / totalWidth * 100;
